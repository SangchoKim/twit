...
class _document_MyDocument extends document_default.a {
  ...
  render() {
    ...
    return __jsx("html", htmlAttrs, __jsx("head", null, this.props.styleTags, values_default()(helmet).map(el => el.toComponent())), __jsx("body", bodyAttrs, __jsx(next_document["Main"], null),  true && __jsx("script", {
      src: "https://polyfill.io/v3/polyfill.min.js?features=es6,es7,es8,es9,NodeList.prototype.forEach&flags=gated"
    }), __jsx(next_document["NextScript"], null)));
  }
